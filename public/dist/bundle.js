...
function ajaxClearTimeoutId() {
  if (timeoutId !== null) {
    clearTimeout(timeoutId); // timeoutIdをリセット
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#entry").on("click", "#add-button", _entry_js__WEBPACK_IMPORTED_MODULE_2__.newPlayerCreate); // 任意のエントリープレイヤーを削除

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#entry').on('click', '.delete', _entry_js__WEBPACK_IMPORTED_MODULE_2__.deletePlayer); // 抽選処理
